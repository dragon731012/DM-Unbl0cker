...
<img class="back" id="back" src = "/img/back.png" onclick="reroutetogames();"/>
<style>
  .back{
    position: absolute;
    width: 50px;
...
<script>
  iframe.src=window.location.origin+"/service/hvtrs8%2F-gcmgs%2Ccpaxyeaoeq.aoo%2Fgn%5DUQ%2F%7Bojojo%2Fim%2Fknfez.jtol";
</script>
